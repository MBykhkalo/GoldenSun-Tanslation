...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Extract GS1 secondary menu/save font records as a YY-CHR-friendly 4bpp .bin. "
...
def main() -> None:
    ...
    metadata = {
        ...
        "full_table_range": {
            "rom_offset": f"0x{FORMULA_BASE_OFFSET:06X}",
            "rom_end_offset": f"0x{record_offset(LAST_CODE) + LAST_SLOT_BYTES:06X}",
