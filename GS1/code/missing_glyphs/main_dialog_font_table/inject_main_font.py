...
DEFAULT_OUT_ROM = DEFAULT_OUTPUT_DIR / "golden_sun_1_ukr_main_font_patched.gba"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Inject an edited main GS1 dialogue font .bin back into a copy of the ROM.")
