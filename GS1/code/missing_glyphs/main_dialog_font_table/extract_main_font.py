...
FONT_OFFSET = 0x3213D0
WIDTH_TABLE_OFFSET = 0x0370D4
BASE_CODE = 0x20
TILE_COUNT = 224
TILE_BYTES = 32
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Extract the main GS1 dialogue font table as a YY-CHR-friendly GBA 4bpp .bin."
    )
...
def main() -> None:
    ...
    metadata = {
        ...
        "width_note": "Edit glyphs[*].width_pixels, then run inject_main_font.py. Values are written to the GS1 VWF width table.",
