...
DEFAULT_OUT_ROM = DEFAULT_OUTPUT_DIR / "golden_sun_2_ukr_secondary_font_patched.gba"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Inject an edited secondary menu/save 4bpp conversion .bin back into a ROM copy."
    )
